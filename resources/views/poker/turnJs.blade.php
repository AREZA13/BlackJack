...
@section('content')
    ...
    <div style="text-align: center;">
        <form class="form-inline" name="formBet" action="{{ route('flopBet') }}" method="POST">
            @csrf
        ...
        <a href="{{ route('river') }}">
            <button type="button" name="getRiver" id="getRiver" hidden="hidden" class="btn btn-primary btn-lg">Get river
            </button>
        </a>
        <br>
        ...
        <script>
            ...
            const getFlop = document.getElementById("getRiver");
